class Ship():
    ...
    length = 1  # длина  
    status_map = [] # массив со статусами точек корабля 
    coord_map = [] # массив с координатами точек корабля
    around_map = [] # точки вокруг корабля
    death = 0  # статус гибели корабля
    prefix = ""   # префикс тега
    ship_correct = 1   # корабль был создан и не выходит за рамки поля
